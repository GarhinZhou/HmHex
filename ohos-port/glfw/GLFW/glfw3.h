...
/* OpenHarmony port: default to GLES3 headers so the desktop <GL/gl.h> is
 * never pulled in (it conflicts with GLES3 type definitions). */
#if (defined(__OHOS__) || defined(__OHOS_FAMILY__)) && !defined(GLFW_INCLUDE_NONE)
