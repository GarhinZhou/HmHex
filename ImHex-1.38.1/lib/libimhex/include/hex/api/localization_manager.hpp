...
EXPORT_MODULE namespace hex {
    ...
    public:
        ...
        auto operator<=>(const UnlocalizedString &other) const {
            return m_unlocalizedString.compare(other.m_unlocalizedString) <=> 0;
        }
        bool operator==(const UnlocalizedString &other) const {
            return m_unlocalizedString == other.m_unlocalizedString;
        }
        auto operator<=>(const std::string &other) const {
            return m_unlocalizedString.compare(other) <=> 0;
        }
