...
namespace hex {
    ...
    /**
     * @brief Informs of an ImGui element's label being registered (ItemInfo)
     *
     * @param elementId the element's ID
     * @param label the element's label (may be null)
     */
    EVENT_DEF_NO_LOG(EventImGuiItemLabeled, ImGuiID, const char *);
