...
// OHOS/GLES3 port: dual-source blending constants used by the ImHex font
// shader are desktop-GL only; define them for GLES3 builds.
#if defined(IMGUI_IMPL_OPENGL_ES3) && !defined(GL_SRC1_COLOR)
