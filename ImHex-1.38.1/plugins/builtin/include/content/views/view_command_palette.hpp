...
namespace hex::plugin::builtin {
    ...
    public:
        ...
        // The command palette width tracks the centered titlebar search box
        // (window_decoration.cpp uses windowSize.x / 2.5) so both stay aligned
        // regardless of window size.
        [[nodiscard]] ImVec2 getMinSize() const override { return ImVec2(ImHexApi::System::getMainWindowSize().x / 2.5F, 150_scaled); }
