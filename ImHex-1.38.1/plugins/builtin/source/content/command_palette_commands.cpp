    ...
    void registerCommandPaletteCommands() {
        ...
        ContentRegistry::CommandPalette::addHandler(
                ...
                [](const auto &input) {
                    ...
                    for (const auto &menuItemEntry : ContentRegistry::UserInterface::impl::getMenuItems()) {
                        const auto &priority = menuItemEntry.first;
                        const auto &entry = menuItemEntry.second;
        ...
        ContentRegistry::CommandPalette::addHandler(
                ...
                [](const auto &input) {
                    ...
                    for (const auto &viewEntry : ContentRegistry::Views::impl::getEntries()) {
                        const auto &unlocalizedName = viewEntry.first;
                        const auto &view = viewEntry.second;
