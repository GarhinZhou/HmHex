...
macro(addBundledLibraries)
    ...
    if (NOT EMSCRIPTEN)
        ...
        # nfd
        if (IMHEX_OHOS_PORT)
            # OpenHarmony port: use the NFD stub (no GTK/portal available)
            add_library(nfd STATIC ${IMHEX_OHOS_PORT_DIR}/nfd_stub/nfd_stub.cpp)
            target_include_directories(nfd PUBLIC ${THIRD_PARTY_LIBS_FOLDER}/nativefiledialog/src/include)
            set(NFD_LIBRARIES nfd)
        elseif (NOT USE_SYSTEM_NFD)
